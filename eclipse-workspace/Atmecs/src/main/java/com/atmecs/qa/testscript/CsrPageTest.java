...
/**This class  will performs the validation of the total link count  
 * and asserting link one by one. 
 * 
...
CsrPageHelper.assertinglinkHeader(driver, commutils, CsrPageHelper.davLinkgetProperty(), CsrPageHelper.davHeadergetProperty());
CsrPageHelper.assertinglinkHeader(driver, commutils, CsrPageHelper.sjudeLinkgetProperty(), CsrPageHelper.sjudeHeadergetProperty());
CsrPageHelper.assertinglinkHeader(driver, commutils, CsrPageHelper.scfLinkgetProperty(), CsrPageHelper.scfHeadergetProperty());
CsrPageHelper.assertinglinkHeader(driver, commutils, CsrPageHelper.ncfLinkgetProperty(), CsrPageHelper.ncfHeadergetProperty());
CsrPageHelper.assertinglinkHeader(driver, commutils, CsrPageHelper.hfhLinkgetProperty(), CsrPageHelper.hfhHeadergetProperty());
